...
document.getElementById("quarter").setAttribute("onClick","document.getElementById("units_select_to_server").value = quarter_units;");
document.getElementById("half").setAttribute("onClick","document.getElementById("units_select_to_server").value = half_units;");
document.getElementById("three_quarters").setAttribute("onClick","document.getElementById("units_select_to_server").value = three_quarters_units;");
</script>
...
<a href="factory_infantry.html">Infantry</a> (<span id="ifood"></span>,<span id="igold"></span>,<span id="iwood"></span>,<span id="iiron"></span>) <a id="quarter" href="#"  onClick="document.getElementById('post_selection_to_server').submit();">1/4</a>|<a id="half" href="#" onClick="document.getElementById('post_selection_to_server').submit();">2/4</a>|<a id="three_quarters" href="#" onClick="document.getElementById('post_selection_to_server').submit();">3/4</a>|<a id="max" href="#" onClick="document.getElementById('post_selection_to_server').submit();">4/4</a>
...
function populate_hidden_text_field(selection) {
document.getElementById("units_select_to_server").value = selection;

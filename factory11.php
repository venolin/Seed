...
document.getElementById("demo").innerHTML = "Nothing in the production chain.";
	...
	document.getElementById("test1").innerHTML = "<br>" + "HP Produced in the last " + time_elapse/1000 + " seconds: " + hp_manufactured;
	document.getElementById("test2").innerHTML = "<br>" + "Infantry Manufactured: " + infantry_manufactured;
	document.getElementById("test3").innerHTML = "<br>" + "Infantry Added: " + infantry_added;
	document.getElementById("test4").innerHTML = "<br>" + "Infantry Manufactured Remainder: " + infantry_manufactured_total;
	}
...
<span id="test1"></span> <!--Adding these as objects prevents the running loop above from displaying a writeln all by itself.-->
<span id="test2"></span>
<span id="test3"></span>
<span id="test4"></span>

...
<form id="post_selection_to_server" method="post"> <!--Hidden form to pass calculated Javascript value to the server once an option is selected-->
    <input type="text" name="units_select_to_server"/> <!--Remember to use name here and not ID or else your form won't bind with your PHP-->
    
    <p>What would you like to produce?</p>
<a href="factory_infantry.html">Infantry</a> (<span id="ifood"></span>,<span id="igold"></span>,<span id="iwood"></span>,<span id="iiron"></span>) <a id="quarter" href="#">1/4</a>|<a id="half" href="#">2/4</a>|<a id="three_quarters" href="#">3/4</a>|<a id="max" href="#" onClick="document.getElementById('post_selection_to_server').submit();">4/4</a>
...
document.getElementById("max").setAttribute("onClick","document.getElementById('units_select_to_server').value = max_units;");
document.getElementById("quarter").setAttribute("onClick","document.getElementById('units_select_to_server').value = quarter_units;document.getElementById('post_selection_to_server').submit();");
document.getElementById("half").setAttribute("onClick","document.getElementById('units_select_to_server').value = half_units;document.getElementById('post_selection_to_server').submit();");
document.getElementById("three_quarters").setAttribute("onClick","document.getElementById('units_select_to_server').value = three_quarters_units;document.getElementById('post_selection_to_server').submit();");
</script>

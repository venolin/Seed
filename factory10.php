...
var hp_manufactured = (time_elapse/1000)/2;

document.writeln("HP Produced in the last " + time_elapse/1000 + " seconds: " + hp_manufactured);
</script>

<script> //Create unit or part of.
var infantry_manufactured; //Still to pull number of owned infantry from database.
var infantry_added=0; //Initialize this or else error will occur below.

infantry_manufactured=hp_manufactured/150;
document.writeln("<br>" +"Infantry Manufactured: " + infantry_manufactured);

infantry_added += Math.floor(infantry_manufactured);
infantry_manufactured -=  infantry_added;

document.writeln("<br>" +"Infantry Added: " + infantry_added);
document.writeln("<br>" +"Infantry Manufactured Remainder: " + infantry_manufactured);
</script>
